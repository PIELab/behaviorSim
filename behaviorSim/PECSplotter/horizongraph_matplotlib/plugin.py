...
class Horizon:
  ...
  def run(self, x, y, labels, figname='',figsize=(15,5), bands=3, colors=("#8BBCD4","#2B7ABD","#0050A0","#EF9483","#E02421", "#A90E0A")): # dark blue, medium blue, light blue, dark red, medium red, light red
  ...
  # private methods
  def create_figure(self, figname,figsize):
    F = plt.figure(figname,figsize=figsize)
    F.clf()
    return F
